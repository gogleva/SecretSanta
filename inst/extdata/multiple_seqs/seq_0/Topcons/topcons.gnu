...
set out '/app/topcons2/test/rst_milti/multiple_seqs/seq_0///Topcons/topcons.large.png'
set tmargin 1.3
set lmargin 11.5
set rmargin 6.5
...
plot '/app/topcons2/test/rst_milti/multiple_seqs/seq_0///Topcons/reliability.final' w l t '' lc rgb "black" lw 4
exit
