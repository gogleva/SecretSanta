...
set out '/app/topcons2/test/rst_milti/multiple_seqs/seq_2///Topcons/total_image.large.png'
set lmargin 13.5
set rmargin 6.5
set tmargin 1.3
...
plot '/app/topcons2/test/rst_milti/multiple_seqs/seq_2///DG1.txt' axes x1y2 w l t '' lt 3 lw 4
exit
