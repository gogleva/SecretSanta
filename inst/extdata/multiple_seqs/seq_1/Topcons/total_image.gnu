...
set out '/app/topcons2/test/rst_milti/multiple_seqs/seq_1///Topcons/total_image.large.png'
set lmargin 13.5
set rmargin 6.5
set tmargin 1.3
...
set object 50 rect from 45.5,38.4 to 56.5,38.6 fc rgb "red" fs noborder
set object 51 rect from 122.5,38.4 to 136.5,38.6 fc rgb "red" fs noborder
set object 52 rect from 201.5,38.4 to 243.5,38.6 fc rgb "red" fs noborder
set object 53 rect from 295.5,38.4 to 338.5,38.6 fc rgb "red" fs noborder
set object 54 rect from 0.5,39.2 to 24.5,39.4 fc rgb "blue" fs noborder
set object 55 rect from 79.5,39.2 to 98.5,39.4 fc rgb "blue" fs noborder
set object 56 rect from 156.5,39.2 to 180.5,39.4 fc rgb "blue" fs noborder
set object 57 rect from 265.5,39.2 to 276.5,39.4 fc rgb "blue" fs noborder
set object 58 rect from 24.5,38.4 to 45.5,39.4 fc rgb "white"
set object 59 rect from 56.5,38.4 to 79.5,39.4 fc rgb "grey" fs noborder
set object 60 rect from 98.5,38.4 to 122.5,39.4 fc rgb "white"
set object 61 rect from 136.5,38.4 to 156.5,39.4 fc rgb "grey" fs noborder
set object 62 rect from 180.5,38.4 to 201.5,39.4 fc rgb "white"
...
set object 65 rect from 24.5,38.4 to 45.5,39.4 fc rgb "white"
set object 66 rect from 56.5,38.4 to 79.5,39.4 fc rgb "grey" fs noborder
set object 67 rect from 98.5,38.4 to 122.5,39.4 fc rgb "white"
set object 68 rect from 136.5,38.4 to 156.5,39.4 fc rgb "grey" fs noborder
set object 69 rect from 180.5,38.4 to 201.5,39.4 fc rgb "white"
...
set object 116 rect from 43.5,47.4 to 56.5,47.6 fc rgb "red" fs noborder
set object 117 rect from 114.5,47.4 to 136.5,47.6 fc rgb "red" fs noborder
set object 118 rect from 201.5,47.4 to 244.5,47.6 fc rgb "red" fs noborder
...
set object 121 rect from 77.5,48.2 to 93.5,48.4 fc rgb "blue" fs noborder
set object 122 rect from 157.5,48.2 to 180.5,48.4 fc rgb "blue" fs noborder
...
set object 125 rect from 56.5,47.4 to 77.5,48.4 fc rgb "grey" fs noborder
...
set object 128 rect from 180.5,47.4 to 201.5,48.4 fc rgb "white"
...
set object 132 rect from 56.5,47.4 to 77.5,48.4 fc rgb "grey" fs noborder
...
set object 135 rect from 180.5,47.4 to 201.5,48.4 fc rgb "white"
...
plot '/app/topcons2/test/rst_milti/multiple_seqs/seq_1///DG1.txt' axes x1y2 w l t '' lt 3 lw 4
exit
