...
set out '/app/topcons2/test/rst_milti/multiple_seqs/seq_3///Topcons/total_image.large.png'
set lmargin 13.5
set rmargin 6.5
set tmargin 1.3
...
set object 9 rect from 298.5,26.4 to 318.5,26.6 fc rgb "red" fs noborder
set object 10 rect from 6.5,27.2 to 36.5,27.4 fc rgb "blue" fs noborder
...
plot '/app/topcons2/test/rst_milti/multiple_seqs/seq_3///DG1.txt' axes x1y2 w l t '' lt 3 lw 4
exit
