...
To demonstarte how **SecretSanta** pipelines could be applied for large-scale analysis of proteomes, we will download all available fungal proteomes using [``biomartr``](https://cran.r-project.org/web/packages/biomartr/index.html) package and apply the same standard secretome prediction pipeline. To speed-up the process, we will use 20 cores available on our local HPC. Please note, retrieval of proteomes might take a while.
