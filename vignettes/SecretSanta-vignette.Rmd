...
If you follow this route, there will be no need to provide paths to the respective tool when running **SecretSanta** functions. This requires modification of ``$PATH`` environment variable. To make the change permanent, edit ``.profile``:
