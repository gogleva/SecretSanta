...
``ask_uniprot()`` is a convenience function, allowing to retrieve information on subcellular localisation of proteins from UniProt in order to compare results obtained within a pipeline with available annotations. This function is mostly relevant for well-annotated and curated genomes.
...
#### Use case: predict secretome for a model species and compare with annotations available in UniProt
