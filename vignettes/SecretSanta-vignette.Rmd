...
sp <- signalp(inp, 
              ...
              run_mode = "starter",
              legacy_method = 'hmm')
# extract out_fasta slot with positive candidates and use these sequences to run TOPCONS prediction on a [web-server](topcons.net):
