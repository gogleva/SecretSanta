...
top_dir <- system.file("extdata", "", package = "SecretSanta")
...
# Now, lets compare the obtained predictions with information on localisation available from UniProtKB:

names_unip <- sapply(all_names, function(x) str_split(x, "\\|")[[1]][2], simplify = TRUE, USE.NAMES = FALSE)

unip_res <- ask_uniprot(names_unip)
