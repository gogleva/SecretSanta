...
2. Add a line with all the path exports.
In this example all the dependecies are installed in the `my_tool` directory:
```{sh, eval = FALSE}
export PATH="/home/my_tools/signalp-4.1:/home/my_tools/signalp-2.0:/home/my_tools/signalp-3.0:/home/my_tools/targetp-1.1:/home/tmhmm-2.0c/bin:/home/my_tools/WoLFPSort/bin:$PATH"
```
...
check2 <- manage_paths(in_path = FALSE, 
...
<!-- ``signalp`` requires specifying ``organism_type`` parameter; possible values include: -->
