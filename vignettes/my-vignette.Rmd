...
<!--                   run_mode = 'slice', -->
<!--                   length_threshold = 100 # minimal length of the outputed slices -->
<!-- ) -->
<!-- ``` -->
