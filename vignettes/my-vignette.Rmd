...
The above code under the hood will run **signalp-2.0** prediction and output result as an instance of ```SignalpResult``` class.
...
signal peptide (SP), chloroplast transit peptide (cTP) or mitochondrial targeting peptide (mTP) in the N-terminus [@Emanuelsson2008].
