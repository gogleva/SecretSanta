...
Currently SecretSanta provides an interface for three recent versions of signalp. The reason for this - signalp4 - seems to be a bit to stringent for secreted proteins from oomycetes and some other organisms(?)
