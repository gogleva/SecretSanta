...
Since ``wolfpsort`` has the same purpouse as ``targetp`` it might be useful to run these functions side by side and compare the results (see [targetp results](#Targetp)). 
