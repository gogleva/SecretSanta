...
```{r manage_paths, echo = TRUE, collapse = TRUE, cache = TRUE}
...
inp <- CBSResult(in_fasta = aa[1:50])
```
...
sp_rescue <- signalp(r_inp,
                    ...
                    truncate = T)
```
The slicing procedure returned 11 additional potentially secreted candidates.
